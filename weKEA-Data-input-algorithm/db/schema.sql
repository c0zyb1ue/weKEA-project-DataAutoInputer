...
CREATE TABLE `orders` (
  ...
  CONSTRAINT `orders_ibfk_2` FOREIGN KEY (`product_option_id`) REFERENCES `product_options` (`id`),
...
CREATE TABLE `users` (
  ...
  `point` decimal(15,3) DEFAULT NULL,
...
CREATE TABLE `wishlists` (
  ...
  `user_id` int NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `wishlists_user_id_product_id_ukey` (`user_id`,`product_id`),
  KEY `product_id` (`product_id`),
...
--
-- Dumping routines for database 'weKEA'
--
